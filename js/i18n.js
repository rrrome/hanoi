...
export const translations = {
  zh: {
    ...
    homeStatus: "选择一个模式开始。",
    homeEyebrow: "经典逻辑游戏",
    homeHeadline: "把复杂，一步步放回秩序。",
    homeDescription: "移动圆盘，建立路径，在最少步数里完成一次清晰的推演。",
  ...
  en: {
    ...
    homeEyebrow: "A CLASSIC LOGIC GAME",
    homeHeadline: "Put complexity back in order, one move at a time.",
    homeDescription: "Move the disks, build a path, and complete a clear line of reasoning in the fewest possible moves.",
