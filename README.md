...
![堆栈塔主页](demo/demo.webp)

原神风格主页集中展示三种游戏入口，并可快速切换语言与主题。

### 新游戏

![堆栈塔新游戏模式](demo/demo_newgame.webp)

新游戏支持 2 至 10 个齿轮，并实时记录当前步数、用时和理论最少步数。

### 教学演示

![堆栈塔教学演示模式](demo/demo_tutorial.webp)
...
选择盘子数量、初始柱和目标柱后开始游戏。玩家只能移动每根柱子最上方的齿轮，并且不能将较大的齿轮放到较小的齿轮上。游戏支持“上一步”和“下一步”操作；走出新的移动后，已有的下一步记录会被清空。
